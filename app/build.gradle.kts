...
//    aws
    ...
    implementation("com.amazonaws:aws-android-sdk-mobile-client:2.22.2@aar") { isTransitive = true }
    implementation("com.amazonaws:aws-android-sdk-auth-userpools:2.22.2@aar") { isTransitive = true }
